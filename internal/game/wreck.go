...
// Ce qu'une caisse ou un obstacle fragile laisse en cédant : la trace au sol, et
// rien d'autre. La simulation la pose et ne l'interroge plus.

package game

// Wreck est ce qu'une caisse ou un obstacle fragile laisse en cédant.
//
...
// qu'elle dit est qu'une chose a été ouverte ici, et cette information reste
...
// possibles que le semis du lieu compte de caisses et d'obstacles, et chaque
// épave remplace ce qui l'a produite.
//
...
type Wreck struct {
	...
	Born Tick
	// Object est la clé de catalogue de ce qui a cédé, **pas celle de sa
	// ruine** : la simulation dit ce qui s'est passé, et le rendu lit dans le
	// manifeste ce que cet objet laisse.
	Object string
	// Across dit que l'objet courait le long de v, et sa ruine avec lui.
	Across bool
}
