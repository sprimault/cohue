...
| rideau de fer | 12 | une vraie décision : douze touches sous la horde |

**Douze et non vingt, et c'est une partie qui l'a dit.** Vingt touches à la cadence du socle font huit secondes immobile, deux fois et demie la cloison, là où chaque obstacle vaut moins du double du précédent : le rideau cessait d'être un prix pour devenir une corvée. À douze, il reste le plus cher des quatre, et quatre secondes et demie sous la horde se décident encore.
...
- **Chaque arme lourde déclare aussi l'effet qu'elle déclenche**, pris dans un vocabulaire fermé — le même dispositif que les recettes de fusion, et pour la même raison : la table choisit un mécanisme, elle n'en invente pas. Sans lui, le moteur n'aurait su produire qu'une chose, celle de la première arme écrite, et la deuxième aurait demandé une branche par nom d'arme.
  ...
  **Elle mitraille en balayant.** Un tir toutes les cent millisecondes, et le canon va et vient d'un bord à l'autre de son éventail en une seconde, autour de la créature la plus proche. Le coup par coup d'une seconde qu'elle avait d'abord picorait : une partie l'a dit, et une tourelle qui ne se sent pas travailler ne se pose pas deux fois. **Ce qui la sépare du fusil est le temps et non la largeur** — le fusil couvre une largeur d'un coup, au contact ; elle arrose un secteur tant qu'il y a quelque chose à arroser. Le balayage se règle par la largeur balayée à la portée, celle de l'éventail, et non par un angle : un point visé décalé de côté puis normalisé, comme la gerbe du fusil, sans trigonométrie dont le dernier bit varierait d'une machine à l'autre. Il suit le rang du tir et non l'horloge, si bien qu'une tourelle qui attend reprend son va-et-vient où elle l'avait laissé ; et un palier de cadence le rend plus dense sans l'accélérer, l'aller-retour restant d'une seconde.

  Elle n'est visée par personne et ne bloque rien ; ce qui borne leur accumulation est la capacité de leur bassin, plusieurs debout n'étant que plusieurs charges déjà dépensées.
...
Ce qu'il coûte se paie du bon côté : au plus une demi-case de mou par bord, là où rien n'est dessiné et où l'on ne passe donc pas. L'inverse — rogner le bloc au plus proche — mettrait des pixels dessinés sur une case franchissable, ce qui est le mauvais sens pour une collision.
