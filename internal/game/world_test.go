...
// capacitesDeTest est le jeu de bassins des cas qui ne cherchent pas à les
// remplir : assez large pour ne jamais refuser, assez étroit pour qu'un bassin
// plein reste atteignable quand un cas le veut.
//
