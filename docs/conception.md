...
Les huit valeurs sont donc exactes par construction : `0`, `±65536` pour les axes, `±46341` pour les diagonales. Ce dernier nombre est `65536 × √2 ⁄ 2` arrondi, **donc une diagonale n'est pas exactement unitaire** — sa norme dépasse la tuile de moins d'une unité. Sans conséquence pour ce à quoi la table sert, une direction de dégagement qui dure un tick ; à savoir avant de la réemployer ailleurs, plutôt qu'à découvrir en cherchant pourquoi des diagonales sont lentes.
