...
- **Cinq revêtements comblent les trous du catalogue** : de l'herbe et un
  passage piéton au quartier — que la place pose désormais le long de son
  avenue —, une moquette au cinéma, qui n'avait aucun sol à lui, du ballast et
  une bande d'éveil à la station. Le ballast ralentit qui le traverse, comme la
  voie qu'il porte.
...
- **Five ground surfaces fill the catalogue's gaps**: grass and a pedestrian
  crossing for the neighbourhood — which the square now lays along its avenue —,
  a carpet for the cinema, which had no floor of its own, ballast and a tactile
  warning strip for the station. Ballast slows whoever crosses it, like the
  track it carries.
